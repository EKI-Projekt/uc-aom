...
COPY scripts/docker/v0_5_0/registrycredentials.json /usr/share/uc-aom/registrycredentials.json
COPY scripts/docker/v0_5_0/portainer.env /var/lib/portainer-ce/portainer.env
